...
#include "HerosBase.generated.h"

UCLASS()
class FIGHTWITHBLOCK_API AHerosBase : public ACharacter
{
	GENERATED_BODY()
...
public:	
	...
	//void ApplyPointDamage(AHerosBase* Causer, int32 DamageValue);


	//void Death(AHerosBase* Causer);
